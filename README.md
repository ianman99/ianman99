...
- **Financial Data Platform** & **Quant Trading System**에 관심 있습니다.
- [**Prober**](https://www.prober.kr) - 실시간 금융 데이터 제공 플랫폼 운영
- DART(전자공시), KRX(한국거래소) 기반 금융 데이터 파이프라인 설계 및 운영
- 이벤트 드리븐 전략 기반 매매 시스템 개발
...
#### API
![HTTP](https://img.shields.io/badge/HTTP-005C9C?style=for-the-badge&logo=apache&logoColor=white)
